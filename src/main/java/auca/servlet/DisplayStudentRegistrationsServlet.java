...
@WebServlet(name = "DisplayStudentRegistrationsServlet", urlPatterns = {"/DisplayStudentRegistrationsServlet"})
public class DisplayStudentRegistrationsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<title>Display Student Registrations</title>");
        out.println("<style>");
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<h2>Display Student Registrations</h2>");
        ...
        if (studentRegistrations.isEmpty()) {
            out.println("<p>No student registrations found.</p>");
        } else {
            out.println("<table>");
            out.println("<tr><th>Registration Code</th><th>Registration Date</th><th>Student ID</th><th>Semester ID</th><th>Department ID</th><th>Actions</th></tr>");
            for (StudentRegistration studentRegistration : studentRegistrations) {
                out.println("<tr>");
                out.println("<td>" + studentRegistration.getRegistrationCode() + "</td>");
                out.println("<td>" + studentRegistration.getRegistrationDate() + "</td>");
                ...
                out.println("<td>" + studentRegistration.getDepartment().getDepartmentId() + "</td>");
                out.println("<td class=\"action-btns\">");
                out.println("<form action=\"DeleteStudentRegistrationServlet\" method=\"post\">");
                ...
                out.println("</form>");
                out.println("<form action=\"UpdateStudentRegistrationServlet\" method=\"get\">");
                out.println("<input type=\"hidden\" name=\"registrationId\" value=\"" + studentRegistration.getRegistrationId() + "\">");
